...
import 'package:todoapp/widgets/title_widget.dart';
import 'package:todoapp/widgets/todo_list_item_widget.dart';
import 'package:todoapp/widgets/toolbar_widget.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            onSubmitted: (newTodo) {
              ref.read(todoListProvider.notifier).addTodo(description: newTodo);
            },
          ),
          const SizedBox(
            height: 20,
